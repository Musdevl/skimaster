...
class CustomerControllerTest {
    ...
    void validCustomerTest() throws Exception {
        CustomerDTO validCustomer = new CustomerDTO(null, "john", "1234567890", Category.ADULT);
    ...
    void inValidCustomerTest() throws Exception {
        CustomerDTO badCreditCardCustomer = new CustomerDTO(null, "badCreditCard", "123", Category.ADULT);
        mockMvc.perform(MockMvcRequestBuilders.post(CustomerCareController.BASE_URI)
                        .contentType(MediaType.APPLICATION_JSON)
