package fr.univcotedazur.skimaster.cashier.connectors;

import com.fasterxml.jackson.databind.ObjectMapper;
import fr.univcotedazur.skimaster.cashier.connectors.externaldto.PaymentReceiptDTO;
...
class BankProxyTest {
    ...
    void payWithSuccess() throws Exception {
        ...
        // When
        Optional<String> payReceiptId = bankProxy.pay(new Customer("nameIsNotImportant", "1234567890", Category.ADULT), 100.0);
        // Then
